...
def process_pdf():
    ...
    try:
        ...
        prompt = generate_prompt(pdf_text, "invoice_items")
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a helpful assistant that extracts information from invoices and returns it in JSON format."
                },
                {
                    "role": "user",
                    "content": str(prompt)
